...
! function() {
  ...
  window.tram = function(t) {
    ...
    L.transform && (Q.transform = [X], J = {
      ...
      skewX: [_],
      skewY: [_]
    }), L.transform && L.backface && (J.z = [k, "translateZ"], J.rotateZ = [_], J.scaleZ = [b], J.perspective = [x]);
    var V = /ms/,
      K = /s|\./;
    return t.tram = e
  }(window.jQuery);
  var e = {},
    ...
    r = t(function(t) {
      ...
      var _ = navigator.userAgent.toLowerCase(),
        ...
        j = f.env.chrome = /chrome/.test(_) && /Google/.test(navigator.vendor) && parseInt(E.match(/chrome\/(\d+)\./)[1], 10),
        z = f.env.ios = /(ipod|iphone|ipad)/.test(_);
      f.env.safari = /safari/.test(_) && !j && !z;
      var M;
      ...
      f.load = function(t) {
        ...
        t = t || {}, k = !0, m.triggerHandler("__wf_destroy"), null != t.domready && (x = t.domready), b.each(h, o), f.resize.off(), f.scroll.off(), f.redraw.off(), d = [], p = [], "pending" === A.state() && l()
