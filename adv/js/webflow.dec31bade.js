...
! function() {
  ...
  window.tram = function(t) {
    ...
    var D = e.frame = function() {
      ...
      R = f(function(e) {
        ...
        e.init = function(e) {
          ...
          q.backface && W.hideBackface && G(this.el, q.backface.css, "hidden")
      ...
      X = f(I, function(t, e) {
        ...
        t.init = function() {
          e.init.apply(this, arguments), this.current || (this.current = {}, J.perspective && W.perspective && (this.current.perspective = W.perspective, G(this.el, this.name, this.style(this.current)), this.redraw()))
        }, t.set = function(t) {
      ...
      B = f(function(e) {
        ...
        function a() {
          ...
          if (i)
            for (D(a), e = C(), t = i; t--;)(n = d[t]) && n.render(e)
        }
        ...
        e.init = function(t) {
          ...
          var n = t.from,
            i = t.to;
          void 0 === n && (n = f.from), void 0 === i && (i = f.to), this.unit = t.unit || "", "number" == typeof n && "number" == typeof i ? (this.begin = n, this.change = i - n) : this.format(i, n), this.value = this.begin + this.unit, this.start = C(), !1 !== t.autoplay && this.play()
        }, e.play = function() {
    ...
    e.fallback = function(t) {
      if (!q.transition) return W.fallback = !0;
      W.agentTests.push("(" + t + ")");
    ...
    q.transform && (Q.transform = [X], J = {
      ...
      skewX: [k],
      skewY: [k]
    }), q.transform && q.backface && (J.z = [_, "translateZ"], J.rotateZ = [k], J.scaleZ = [b], J.perspective = [x]);
    var V = /ms/,
      K = /s|\./;
    return t.tram = e
  }(window.jQuery);
  var e = {},
    ...
    r = t(function(t) {
      ...
      var k = navigator.userAgent.toLowerCase(),
        ...
        j = f.env.chrome = /chrome/.test(k) && /Google/.test(navigator.vendor) && parseInt(T.match(/chrome\/(\d+)\./)[1], 10),
      ...
      var M = "resize.webflow orientationchange.webflow load.webflow";
      f.resize = s(m, M), f.scroll = s(m, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"), f.redraw = s(), f.location = function(t) {
        window.location = t
    ...
    a = (t(function(t) {
      ...
      e.define("edit", t.exports = function(t, n, i) {
        ...
        return w ? m() : p.search ? (/[?&](edit)(?:[=&?]|$)/.test(p.search) || /\?edit$/.test(p.href)) && m() : h.on(v, r).triggerHandler(v), f
      })
    }), t(function(t) {
      /*!
  ...
  t(function(t) {
    ...
    e.define("tabs", t.exports = function(t) {
      function i() {
        h = g && e.env("design"), (f = v.find(y)).length && (f.each(s), e.env("preview") && !T && f.each(a), r(), o())
      }

      function r() {
        e.redraw.off(d.redraw)
      }

      function o() {
        e.redraw.on(d.redraw)
      }

      function a(e, n) {
        var i = t.data(n, y);
        i && (i.links && i.links.each(k.reset), i.panes && i.panes.each(k.reset))
      }
      ...
      function s(e, n) {
        ...
        if (r || (r = t.data(n, y, {
            el: i,
            config: {}
          })), r.current = null, r.menu = i.children(".w-tab-menu"), r.links = r.menu.children(".w-tab-link"), r.content = i.children(".w-tab-content"), r.panes = r.content.children(".w-tab-pane"), r.el.off(y), r.links.off(y), u(r), !h) {
      ...
      function l(n, i) {
        function r() {
          if (f.removeClass(_).css({
              opacity: "",
              transition: "",
              transform: "",
              width: "",
              height: ""
            }), l.addClass(_).each(k.intro), e.redraw.up(), !o.intro) return p(l).set({
            opacity: 1
          });
          p(l).set({
            opacity: 0
        ...
        if (s !== n.current) {
          n.current = s, n.links.each(function(e, n) {
            var i = t(n);
            n.getAttribute(b) === s ? i.addClass(x).each(k.intro) : i.hasClass(x) && i.removeClass(x).each(k.outro)
          });
          var u = [],
            c = [];
          n.panes.each(function(e, n) {
            var i = t(n);
            n.getAttribute(b) === s ? u.push(n) : i.hasClass(_) && c.push(n)
          });
          var l = t(u),
            f = t(c);
          if (i.immediate || o.immediate) return l.addClass(_).each(k.intro), f.removeClass(_), void(T || e.redraw.up());
          f.length && o.outro ? (f.each(k.outro), p(f).add("opacity " + o.outro + "ms " + a, {
            fallback: w
          }).start({
            opacity: 0
          }).then(r)) : r()
      ...
      var f, h, d = {},
        ...
        k = n.triggers,
        T = !1;
      return d.ready = d.design = d.preview = i, d.redraw = function() {
        T = !0, i(), T = !1
      }, d.destroy = function() {
